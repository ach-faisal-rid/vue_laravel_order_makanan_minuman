                            ...
                            <div class="space-y-5">
                                <div>
                                    ...
                                    <div class="mt-2.5 relative text-gray-400 focus-within:text-gray-600">
                                        ...
                                        <input type="email" id="email" v-model="email" placeholder="Enter email to get started"
...
const login = async () => {
    try {
        const response = await axios.post('http://vue_laravel_order_makanan_minuman.test/api/login', {
            email: email.value,
        ...
        localStorage.setItem('role_id', JSON.stringify(response.data.data.level));
