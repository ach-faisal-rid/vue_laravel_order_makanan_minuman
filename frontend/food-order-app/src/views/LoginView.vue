                            ...
                            <div class="space-y-5">
                                <div>
                                    ...
                                    <div class="mt-2.5 relative text-gray-400 focus-within:text-gray-600">
                                        ...
                                        <input type="email" name="email" id="email" v-model="email" placeholder="Enter email to get started"
                                            class="block w-full py-4 pl-10 pr-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-blue-600 caret-blue-600" required/>
                                    </div>
                                </div>
